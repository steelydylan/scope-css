...
declare const Escaper: {
	...
	content: string[];
	symbols: RegExp;
	replace(str: string, content?: string[]): string;
	replace(str: string, params: EscaperParams | EscaperAll[] | -1, content?: string[]): string;
	paste(str: string, content?: string[], rgxp?: RegExp): string;
};

declare module 'escaper/src/escaper.js' {
